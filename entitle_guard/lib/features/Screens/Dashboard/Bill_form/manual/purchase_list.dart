...
import '../scanning/verify/Verifyitems.dart'; // This import is needed for using Provider
import 'package:intl/intl.dart';


class TableWidget extends StatefulWidget {
  final Bill bill;
  const TableWidget({super.key, required this.bill});
          ...
          for (var item in bill.billItems) {
            rows.add(DataRow(
              cells: [
                ...
                DataCell(Text(item.warantyEndDate ?? '')),
